...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            Log.e("Nitin", String.format("Error code:%d", geofencingEvent.getErrorCode()));
            return;
        }
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            Log.e("Nitin", String.format("unknown transition: %d", geofenceTransition));
            return;
        }

        // TODO (6) Show a notification to alert the user that the ringer mode has 0.
    ...
    private void sendNotification(Context context, int transitionType) {
        ...
        if (transitionType == Geofence.GEOFENCE_TRANSITION_ENTER) {
            builder.setSmallIcon(R.drawable.ic_volume_off_white_24dp)
                    ...
                    .setContentTitle(context.getString(R.string.silent_mode_active));
